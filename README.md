...
> 
>
> 📦 **下载最新版本：** [Zotero 插件 XPI](https://github.com/copyhubduo/zotero-pdf2zh/releases/latest/download/zotero-pdf-2-zh.xpi) · [Server](https://github.com/copyhubduo/zotero-pdf2zh/releases/latest/download/server.zip) · [完整文档](https://zotero-pdf2zh.github.io/)
...
- 跳转至本项目总结的常见问题：[常见问题(FAQ)](https://github.com/copyhubduo/zotero-pdf2zh?tab=readme-ov-file#%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98faq)
...
# 2. 下载并解压server文件夹
# 如果server.zip下载失败, 可以直接访问: https://github.com/copyhubduo/zotero-pdf2zh/releases/latest/download/server.zip 手动下载
wget https://github.com/copyhubduo/zotero-pdf2zh/releases/latest/download/server.zip
unzip server.zip
...
最新版本 v4.1.1 [下载链接](https://github.com/copyhubduo/zotero-pdf2zh/releases/latest/download/zotero-pdf-2-zh.xpi)
...
- 参考：[做了一个 homebrew 的 tap，便于 mac 用户直接使用 #187](https://github.com/copyhubduo/zotero-pdf2zh/issues/187) by [@NightWatcher314](https://github.com/NightWatcher314)
